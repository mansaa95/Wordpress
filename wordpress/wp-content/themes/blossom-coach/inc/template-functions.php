...
function blossom_coach_header(){     
    ...
    <header class="site-header" itemscope itemtype="http://schema.org/WPHeader" itemscope itemtype="http://schema.org/WPHeader">		
        ...
        <div class="header-t">
			...
			<?php
                ...
                if( blossom_coach_social_links( false ) || $ed_search ){
                    ...
                    if( $ed_search ){
                        echo '<div class="header-search"><span class="fa fa-search"></span><div class="header-search-form">';
                        get_search_form();
        ...
        <div class="main-header">
			<div class="wrapper">
				<div class="site-branding<?php if( has_custom_logo() ) echo ' icon-text'; ?>" itemscope itemtype="http://schema.org/Organization">
					<div class="site-logo">
						<?php 
                        if( has_custom_logo() ){
                            the_custom_logo();
