...
function blossom_coach_get_the_archive_title( $title ){
    ...
    if( is_category() ){
        if( $ed_prefix ){
            ...
            $title = sprintf( __( '%1$sBrowsing Categories%2$s %3$s', 'blossom-coach' ), '<p class="subtitle">', '</p>', '<h1 class="page-title">' . single_cat_title( '', false ) . '</h1>' );
        }
    }elseif( is_tag() ){
        if( $ed_prefix ){
            ...
            $title = sprintf( __( '%1$sBrowsing Tags%2$s %3$s', 'blossom-coach' ), '<p class="subtitle">', '</p>', '<h1 class="page-title">' . single_tag_title( '', false ) . '</h1>' );
        }
    }elseif( is_year() ){
        if( $ed_prefix ){
...
if( ! function_exists( 'blossom_coach_pro_exclude_cat' ) ) :
/**
 * Exclude post with Category from blog and archive page. 
*/
function blossom_coach_pro_exclude_cat( $query ){
...
add_filter( 'pre_get_posts', 'blossom_coach_pro_exclude_cat' );
