...
function blossom_coach_customize_register_general( $wp_customize ) {
    	...
    	$wp_customize->add_control(
    		new Blossom_Coach_Note_Control( 
    			...
    			array(
    				'section'     => 'header_settings', 
                    'label'       => __( 'Header Newsletter Shortcode', 'blossom-coach' ),   				
                    'description' => sprintf( __( 'Please install and activate the recommended plugin %1$sBlossomThemes Instagram Feed%2$s.', 'blossom-coach' ), '<a href="' . admin_url( 'themes.php?page=tgmpa-install-plugins' ) . '" target="_blank">', '</a>' ),
    			)
    		)
       );  
    }
    ...
    $wp_customize->add_control(
		new Blossom_Coach_Toggle_Control( 
			...
			array(
				'section'     => 'post_page_settings',
				'label'	      => __( 'Hide Author', 'blossom-coach' ),
                'description' => __( 'Enable to hide author section.', 'blossom-coach' ),
			)
		)
	);
    	...
    	$wp_customize->add_control(
    		new Blossom_Coach_Note_Control( 
    			...
    			array(
    				'section'     => 'newsletter_settings', 
                    'label'       => __( 'Newsletter Shortcode', 'blossom-coach' ),   				
                    'description' => sprintf( __( 'Please install and activate the recommended plugin %1$sBlossomThemes Instagram Feed%2$s. After that option related with this section will be visible.', 'blossom-coach' ), '<a href="' . admin_url( 'themes.php?page=tgmpa-install-plugins' ) . '" target="_blank">', '</a>' ),
    			)
    		)
       ); 
    }
