<?php
/**
 * Hasten Lite Customizer Notification Section Class.
 *
 * @package Hasten Lite
 */
...
/**
 * Hasten_Lite_Customizer_Notify_Section class
 */
class Hasten_Lite_Customizer_Notify_Section extends WP_Customize_Section {
	/**
	 ...
	 * @var    string
	 */
	public $type = 'hl-customizer-notify-section';
	/**
		...
		<# if( data.recommended_actions.length > 0 || data.recommended_plugins.length > 0 ){ #>
			<li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }} cannot-expand">
				...
				<h3 class="accordion-section-title">
					...
					<# if( data.recommended_actions.length > 0 ){ #>
						<span class="hl-customizer-notify-actions-count">
							...
							<div class="epsilon-recommeded-actions-container epsilon-required-actions" data-index="{{ data.recommended_actions[action].index }}">
								<# if( !data.recommended_actions[action].check ){ #>
									<div class="epsilon-recommeded-actions">
										...
										<span data-action="dismiss" class="dashicons dashicons-no hl-customizer-notify-dismiss-recommended-action" id="{{ data.recommended_actions[action].id }}"></span>
							...
							<div class="epsilon-recommeded-actions-container epsilon-recommended-plugins" data-index="{{ data.recommended_plugins[action].index }}">
								<# if( !data.recommended_plugins[action].check ){ #>
									<div class="epsilon-recommeded-actions">
										...
										<span data-action="dismiss" class="dashicons dashicons-no hl-customizer-notify-dismiss-button-recommended-plugin" id="{{ data.recommended_plugins[action].id }}"></span>
